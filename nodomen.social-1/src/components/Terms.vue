<template>
  ...
  <section class="terms">
    <div class="terms__container container">
      <span class="terms__icon">
        <img src="../assets/18+.svg" loading="lazy" width="50" height="50" alt="Icon">
      </span>
      ...
      <p>Unless otherwise stated, site and/or its licensors own the intellectual property rights for all material on
        site. All intellectual property rights are reserved. You may access this from site for your own personal use
      ...
      <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. site does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of site,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions. To the extent permitted by applicable
        laws, site shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered
      ...
      <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of site; and
      ...
      <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
        you must inform us by sending an e-mail to site. Please include your name, your organization name, contact
